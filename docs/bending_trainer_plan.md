...
**Implemented.** Technique copy is localized, overbend guidance no longer
...
reed attack. A short pitch history distinguishes smooth travel from detector
jitter; unstable input is shown explicitly and cannot advance the drill.
